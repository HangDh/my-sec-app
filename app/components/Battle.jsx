...
class PlayerInput extends React.Component {
  ...
  handleSubmit(event) {
    ...
    // Wywołaj funkcje 'onSubmit' z propsow (funkcja podawana przy tworzeniu komponentu w renderze rodzica) z parametrem 'this.state.username'
...
function PlayerPreview({ username, onReset, label }) {
  return (
    <article className="card">
      <h3 class="player-label">{label}</h3>
      <div className="split">
